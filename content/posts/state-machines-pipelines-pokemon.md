...
I built the first version of Babiri in 6 weeks, which is a short time to deliver in hindsight. Though the first version was delivered rapidly, I was unsatisfied with the maintenance required to keep it running. I approach projects aiming to build robust and maintainable software as it's difficult to reduce operations work while balancing a full-time position. I've also gained an appreciation for learning new technologies and design patterns through tackling new projects. Exploring new ideas allows me to grow as an engineer, which is something very important to me. Though the design patterns may seem overly complicated, I think the trade-offs between writing robust software and prolonging time-to-deliver weighs more favourably on the former.
...
-   Everyone I talked to at Orlando Regionals. Appreciate the food for thought for the site moving forward.
